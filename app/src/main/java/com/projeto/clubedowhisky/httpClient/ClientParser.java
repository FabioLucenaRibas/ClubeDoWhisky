...
public class ClientParser {
    ...
    public static Clients logar(String email, String password) throws IOException{
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://localhost:8080/clubedowhisky-API/")
        ...
        Clients clients = api.logar(email,password).execute().body();
